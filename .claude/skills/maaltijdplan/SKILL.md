...
- **Smaakvoorkeuren** (zie CLAUDE.md): allebei geen aubergine; Ralf geen paddenstoelen; vriendin geen linzen en niet heel pittig. Kies bij voorkeur gerechten die zó voor beiden werken. **Splits alleen** bij een echt gezondheidsvoordeel (linzen → basis samen, Ralfs pan + linzen, haar pan + kikkererwten/bonen) of als het kosteloos kan (mild koken, Ralf voegt zelf pit toe). Zet beide varianten op de boodschappenlijst.
